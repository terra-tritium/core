...
class Travel extends Model
{
    ...
    CONST MISSION_SPIONAGE = 11;
    CONST MISSION_COLONIZATION = 12;
    CONST MISSION_CHALLANGE = 15;
    CONST RETURN_CHALLANGE = 16;
    CONST DEFENSE_RETURN = 17;
    CONST DOMAIN_RETURN = 18;
