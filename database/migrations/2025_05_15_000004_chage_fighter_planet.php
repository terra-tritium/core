...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::table('fighters', function (Blueprint $table) {
            $table->dropForeign('fighters_planet_foreign');
        });

        // Altera o tipo da coluna de BIGINT para VARCHAR
        DB::statement('ALTER TABLE fighters MODIFY planet VARCHAR(255)');
    }

    public function down(): void
    {
        // Reverte o tipo de volta para BIGINT
        DB::statement('ALTER TABLE fighters MODIFY planet BIGINT');
